...
|
*/
$config['base_url'] = 'http://localhost/bem_ft_unsoed/pengguna';
$config['assets_kegiatan'] = $_SERVER["DOCUMENT_ROOT"]."/bem_ft_unsoed/assets/kegiatan/";
$config['url_kegiatan'] = 'http://localhost/bem_ft_unsoed/assets/kegiatan/';
$config['assets_majalah'] = $_SERVER["DOCUMENT_ROOT"]."/bem_ft_unsoed/assets/majalah/";
$config['url_majalah'] = 'http://localhost/bem_ft_unsoed/assets/majalah/';
